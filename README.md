...
## 📌 Raise the issue
Đặt vấn đề:
Câu 1: Phân mảnh hành vi cốt lõi: Thời lượng sử dụng mạng xã hội trung bình (daily_social_media_hours) và mức độ nghiện (addiction_level) có sự phân hóa như thế nào giữa các nhóm giới tính (gender) và các độ tuổi (age) khác nhau?
